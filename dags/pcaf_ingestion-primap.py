...
with DAG(
    ...
    def load_data_to_s3_bucket():
        ...
        import urllib.request
        from airflow.providers.amazon.aws.hooks.s3 import S3Hook
        url = "https://zenodo.org/records/13752654/files/Guetschow_et_al_2024a-PRIMAP-hist_v2.6_final_no_rounding_13-Sep-2024.csv?download=1"
    ...
    trino_drop_table = SQLExecuteQueryOperator(
        ...
        conn_id="trino_connection",
        sql=f"drop table if exists hive.pcaf.primap",
        handler=list,
    )
